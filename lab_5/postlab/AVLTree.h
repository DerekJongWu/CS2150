...
class AVLTree {
 ...
 private:
  ...
  void insert(const string &x, AVLNode *&b);  
  string pathTo(const string &x, AVLNode *b) const; 
  bool find(const string &x, AVLNode *b) const; 
  int numNodes(AVLNode *b) const;
  int bfac(AVLNode *b);
  void cleanTree(AVLNode *&n);    
};
