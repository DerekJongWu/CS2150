...
/**
 *@brief This method randomly selects some cities and creates a world out of them. 
 *@return An Earth given the randoly selected cities.
 *@param xsize The size of the Earth
 *@param ysize The size of the Earth
 *@param num_cities How many cities are in this Earth
 *@param seed 
 */
 ...
 *@return all of the cities and their position in the world                                                                                                  */
...
/**
 *@return a table that lists all of the cities and their position in the world 
...
/**
 *@return a decimal that tells the distance from two cities
 *@param city1 the first city that is needed to compute the distance.
 *@param city2 the second city that is needed to compute the distance. 
...
/**
 *@return a vector with a random assortment of cities. 
 *@para length determines how many cities are to be included in the vector. 
